...
public class PostFeedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.mView = inflater.inflate(R.layout.fragment_post_feed, container, false);
    ...
    private void renderPosts(JSONArray json) throws JSONException{
        ...
        for (int i=0;i<json.length();i++){
            ...
            post = new Post(postJSON.getInt("id"),postJSON.getString("name"),postJSON.getJSONObject("user").getString("name"),"https://cdn.pixabay.com/photo/2014/03/05/19/23/dog-280332_960_720.jpg");
            posts.add(post);
        }
